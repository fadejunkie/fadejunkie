# Arquero Co. — E-Commerce Storefront

**Client:** Arquero Co. (welder lifestyle brand — apparel, work gear, identity drops)  
**Stack:** Next.js 16 (App Router, TypeScript, Tailwind) + Convex + Stripe  
**Convex deployment:** anonymous-ecomm (local) — run `npx convex dev --once` to get URL  
