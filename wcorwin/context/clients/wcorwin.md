...
- **Source:** `wcorwin/` (Vite + React + Convex)
...
## Key Files
- `wcorwin/seo-audit-wcorwin.com.md` — Full 5-pillar audit
- `wcorwin/src/data.js` — Task phases, statuses, project metadata
- `wcorwin/src/SEOJourneyTracker.jsx` — Client-facing tracker UI
- `wcorwin/convex/schema.ts` — wcorwinTasks table schema
- `wcorwin/WCORWIN MONTH 1 RECEIPT.pdf` — Payment receipt
