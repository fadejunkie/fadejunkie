...
export const PHASES = [
  {
    ...
    tasks: [
      ...
      { name: "GSC ownership verified", status: "done", detail: "Verified 2026-03-27 via domain name provider (DNS)" },
  ...
  },
  {
    ...
    fee: "$950",
    tasks: [
      { name: "Rewrite all title tags", status: "done", detail: "Unique title for every key non-IDX page — applied 2026-03-27" },
      { name: "Write unique meta descriptions", status: "done", detail: "Unique meta descriptions for 10 pages — applied 2026-03-27" },
      { name: "Implement LocalBusiness schema", status: "done", detail: "JSON-LD RealEstateAgent schema injected via Extra Code — 2026-03-27" },
      { name: "Verify & submit XML sitemap", status: "done", detail: "Submitted & verified in GSC — 2026-03-27" },
      { name: "Optimize Google Business Profile", status: "done", detail: "Photos, messaging, categories, hours" },
      { name: "Baseline keyword tracking setup", status: "done", detail: "Top 20 keywords in GSC — \"realtor new braunfels\" pos 2.8, \"new braunfels real estate\" pos 9.6" },
  ...
  },
  {
    ...
    fee: "$950",
    tasks: [
      { name: "Canyon Lake neighborhood guide", status: "done", detail: "Live at wcorwin.com/canyon-lake-tx-real-estate" },
      { name: "Gruene, TX neighborhood guide", status: "done", detail: "Live at wcorwin.com/gruene-tx-real-estate" },
      { name: "Spring Branch neighborhood guide", status: "done", detail: "Live at wcorwin.com/spring-branch-tx-real-estate" },
      { name: "Seguin neighborhood guide", status: "done", detail: "Live at wcorwin.com/seguin-tx-real-estate" },
      { name: "VA / Military Homebuyer page", status: "done", detail: "Live at wcorwin.com/va-military-homebuyer" },
      { name: "First-Time Home Buyer Guide", status: "done", detail: "Live at wcorwin.com/first-time-home-buyer" },
      { name: "Buyer Rebate Program page", status: "pending", detail: "Awaiting rebate % confirmation from Joe" },
