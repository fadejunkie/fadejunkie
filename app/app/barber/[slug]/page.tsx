    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-2xl mx-auto px-6 py-12">
        ...
        {barber.services.length > 0 && (
          <div className="mb-6">
            <p className="font-mono text-[0.625rem] font-medium tracking-[0.14em] uppercase text-muted-foreground mb-2">Services</p>
        ...
        {gallery.length > 0 && (
          <div>
            <p className="font-mono text-[0.625rem] font-medium tracking-[0.14em] uppercase text-muted-foreground mb-3">Gallery</p>
