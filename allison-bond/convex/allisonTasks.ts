...
export const setTask = mutation({
  ...
  handler: async (ctx, { projectId, key, value }) => {
    ...
    if (existing) {
      ...
      await ctx.db.insert("allisonTasks", { projectId, taskKey: key, completed: value });
    }
  },
});
...
export const saveAgreement = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    if (existing) {
      ...
      await ctx.db.insert("allisonAgreements", { projectId: args.projectId, ...doc });
    }
  },
});
...
export const saveDiscovery = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    if (existing) {
      ...
      await ctx.db.insert("allisonDiscovery", {
...
export const addDeliverable = mutation({
  ...
  handler: async (ctx, args) => {
    await ctx.db.insert("allisonDeliverables", args);
  },
});

export const removeDeliverable = mutation({
  args: { id: v.id("allisonDeliverables") },
